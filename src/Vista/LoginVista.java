...
public class LoginVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtcontraseña, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    Usuario user = controlador.autenticarUsuario(usuario, contrasenia);

    if (user != null) {
        JOptionPane.showMessageDialog(this, "✅ Bienvenido, " + user.getNombreUsuario(), "Acceso correcto", JOptionPane.INFORMATION_MESSAGE);
        InicioVista menu = new InicioVista(user);
        menu.setVisible(true);
        this.dispose();
    } else {
        JOptionPane.showMessageDialog(this, "❌ Usuario o contraseña incorrectos o usuario inactivo", "Acceso denegado", JOptionPane.ERROR_MESSAGE);
